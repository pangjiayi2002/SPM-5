...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        <c:forEach var="task" items="<%=tasks%>">
            <tr>
                ...
                <td>${task.content}</td>
                <td>
                    <span><a class="viewNotice" href="userAnswerList.jsp?id=${task.id}"><img
                            src="${pageContext.request.contextPath }/images/read.png" alt="批改作业" title="批改作业"/></a></span>
                    <span><a class="modifyNotice" href="taskModify.jsp?id=${task.id}"><img
                            src="${pageContext.request.contextPath }/images/xiugai.png" alt="修改"
                            title="修改"/></a></span>
                    <span><a class="deleteNotice"
                             href="${pageContext.request.contextPath}/TaskDeleteServlet?id=${task.id}"
                             title=${task.content}><img src="${pageContext.request.contextPath}/images/schu.png"
    ...
    <a href="taskAdd.jsp" id="add">添加作业</a>
</div>
