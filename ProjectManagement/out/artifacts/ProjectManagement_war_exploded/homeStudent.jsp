...
<div>
    ...
    <div>
        ...
        <input type="submit" value="学习资料库" style="background-color: #5994d6;width:150px;height:100px;font-size: 20px;border: none" onclick="window.location.href='book/软件项目管理案例教程 .pdf'">
    </div>
</div>
</body>
</html>
