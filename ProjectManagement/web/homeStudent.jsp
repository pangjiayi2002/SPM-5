...
<div>
    ...
    <div id="buttons">
        ...
        <input type="submit" value="作业" style="background-color: #8bc93a;width:150px;height:100px;font-size: 20px;border: none" onclick="window.location.href='stuDoTask.jsp'">
        <input type="submit" value="测试" style="background-color: aquamarine;width:150px;height:100px;font-size: 20px;border: none " onclick="window.location.href='stuDoTest.jsp'">
        <input type="submit" value="留言板" style="background-color: #faca0d;width:150px;height:100px;font-size: 20px;border: none">
        <input type="submit" value="学习资料库" style="background-color: #5994d6;width:150px;height:100px;font-size: 20px;border: none" onclick="window.location.href='studyResource.jsp'">
